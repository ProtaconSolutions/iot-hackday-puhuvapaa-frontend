(function() {
  ...
  /**
   * @description Generic HTTP status code service
   * @namespace   HttpStatusService
   * @memberOf    Factories
   * @ngInject
   *
   * @returns {{
   *    getStatusCodeText: Factories.HttpStatusService.getStatusCodeText
   *  }}
   * @constructor
   */
  function HttpStatusService() {
     ...
     * @memberOf  Factories.HttpStatusService
     *
